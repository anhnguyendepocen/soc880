...
* [Stack Overflow](http://stackoverflow.com). Programming and developer Q&A site with a substantial amount of useful R and ggplot material. Search as normal for keywords, add tags enclosed in square brackets, e.g. `[ggplot]`, to restrict results to the library or language you want answers in.
...
* Jennifer Bryan, [R basics, workspace and working directory, RStudio projects](http://stat545-ubc.github.io/block002_hello-r-workspace-wd-project.html). This is a very useful introduction to the basics of R and RStudio, if you are completely unfamiliar with R.
...
## Week 2: One Variable, Two Variables, Three Variables

## Week 3: Exploring Whole Datasets

## Week 4: Refining Plots for Presentation

## Week 5: Presenting Results from Models

## Week 6: Networks, Maps, and Texts
