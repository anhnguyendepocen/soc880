...
* Scales, Lengths, Areas, and Angles.
* Dotplots, Histograms, and Boxplots.
* Scatterplots and Smoothers.
* Working with base R, `ggplot` and `lattice` graphics. 

## Week 3: Exploring Whole Datasets, Creating More Complex Figures

* Shaping, reshaping, and summarizing data.
* Pairs, generalized pairs, co-plots, small-multiples, and panels.
...
## Week 5: Networks, Maps, Trees

* Network data
* Clustering, Heatmaps, and Mosaics
* Maps and Map Projections 

## Week 6: Refining Plots for Presentation

* Post-processing plots.
* Plots for slides, screens, and printed pages.
* Annotation, typography, integration with page or slides.
